...
<p align="center">
  <img src="https://github.com/guillemontecinos/itp_fall_2018_generative_music/blob/master/week_11/training.png" align="middle" width="50%">
</p>

10 MIDI files were [generated](https://github.com/guillemontecinos/itp_fall_2018_generative_music/tree/master/week_11/generated/melody_rnn/Radiohead) by this process. Within this run, just 2/10 outputs sound similar to Radiohead's melodies, but they really sound like it. It doesn't mean that Magenta's models are inaccurate, by contrast the accurate results are very likely. It's important to consider that the model is trained with the entire files, which means that it takes information from every instrument of the song that can affect the melody output.

Listen the generated melodies [here](https://soundcloud.com/guillemontecinos/sets/radiohead-rnn).
